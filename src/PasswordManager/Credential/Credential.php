...
use Keestash\Sdk\PasswordManager\Entity\Credential as CredentialEntity;
...
class Credential
{
     ...
     */
    public function create(CredentialEntity $credential, ApiCredentialsInterface $apiCredentials): array
    {
